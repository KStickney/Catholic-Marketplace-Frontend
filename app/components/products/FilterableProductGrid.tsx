...
> & {
  ...
  return (
    <div className="mt-8 grid sm:grid-cols-5 gap-x-6 bg-[#fdf6f0] rounded-2xl p-6 shadow-sm">
      <FacetFilterControls
      ...
      {result.items.length > 0 ? (
        <div className="sm:col-span-5 lg:col-span-4 space-y-8">
          <div className="grid grid-cols-1 gap-y-12 gap-x-8 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-10">
          ...
          <div className="flex flex-row justify-between items-center gap-4 mt-4">
            <span className="self-start text-gray-400 text-sm mt-2">
              {t('product.showing')}{' '}
              {translatePaginationFrom(
                appliedPaginationPage,
                appliedPaginationLimit,
